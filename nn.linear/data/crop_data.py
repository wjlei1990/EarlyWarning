...
def extract_on_stream(src, stations, waveform_file, window_file,
...
def save_data(data, magnitude, distance, interp_npts, outputfn):
...
def main():
    ...
    #for idx in range(100):
        ...
        _d = extract_on_stream(src, stations, waveform_file, window_file,
                               interp_npts, interp_sampling_rate)
    ...
    save_data(data, magnitude, distance, interp_npts, "test.h5")
